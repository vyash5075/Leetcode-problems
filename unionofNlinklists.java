...
public class unionofNlinklists {
    ...
    count++;
        ...
        Node p=start1;
        Node q;
        while(p!=null&&p.address!=null)
        {
            if(p.data==p.address.data)
            {
                q=p.address.address;
                if(q==null)
                {
 ...
 System.out.println("union of given n nodes are");
        Node ptr9=start1;
        while(start1!=null)
        {
            System.out.println(ptr9.data);
            ptr9=ptr9.address;
        }
